...
class Hand():
    def __init__(self, player, parent):
        ...
        self.balance_box = tk.Label(parent.bottom_frame,
                               ...
                               fg='white',
                               font=('Times', 15))
        #self.bet_size_box = tk.Label(parent.bottom_frame, text=f'BetSize: '{player.value_of_balance}, bg='blue', fg='white', font=('Times', 15))
    ...
    def updateimages(self, dealer_card1_image):
        ...
        dealer1_yposition = int(dealer_card1_image.winfo_rooty()) + 87
        card_images[self.dealer.cards[1]][0].place(x=dealer_card1_image.winfo_rootx(), y=dealer1_yposition)
        ...
        for i in range(1, len(self.player.cards)):
            ...
            dealer1_yposition = int(dealer_card1_image.winfo_rooty()) + 87
            card_images[self.player.cards[i+1]][0].place(x=dealer_card1_image.winfo_rootx(), y=dealer1_yposition)
...
class Window_Two(tk.Frame):
    def __init__(self, parent):
        ...
        deal_button = tk.Button(self.top_frame, text='DEAL', bg='blue', fg='black', font=('Times', 15),
                                command=lambda: self.confirm_bet(deal_button, dealer_card1_image))
        ...
        for player in self.players:
            ...
            self.hands.append(Hand(dealer, self))
    ...
    def confirm_bet(self, deal_button, dealer_card1_image):
        ...
        for hand in self.hands:
            ...
            hand.dealer.initialcards(self.deck)


            hand.updateimages(dealer_card1_image)
